...
final class TestPOAManagerServer extends test.common.TestBase
{
    final static class POAManagerProxy_impl extends POAManagerProxyPOA
    {
        ...
        public void
        deactivate(boolean a, boolean b)
            throws test.poa.POAManagerProxyPackage.AdapterInactive
        {
            try
            {
        ...
        get_state()
        {
            return test.poa.POAManagerProxyPackage.State.
                   from_int(manager_.get_state().value());
        }
    }
    ...
    main(String[] args)
    {
        ...
        try
        {
            ...
            org.omg.CORBA.Object objDSI =
                retain.create_reference_with_id(oidDSI, "IDL:test/poa/Test:1.0");
	    ...
	    //
	    // Spawn a thread to find out whether a
