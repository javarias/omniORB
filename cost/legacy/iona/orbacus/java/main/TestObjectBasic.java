    ...
    implements TestObject
{
...

	{
...

		{
		    ...
		    ORBTest_Basic.Intf ti2 = (
			ORBTest_Basic.IntfHelper.extract(ret)
		    );
...

	{
	    ...
	    ORBTest_Basic.IntfHolder inOut = (
		new ORBTest_Basic.IntfHolder(
...

	{
	    ...
	    FixedArrayBoundSequenceHolder inOut =
		new FixedArrayBoundSequenceHolder(new short[4][2][3][4]);
	    for(l = 0 ; l < 4 ; l++)
		for(i = 0 ; i < 2 ; i++)
		    for(j = 0 ; j < 3 ; j++)
			for(k = 0 ; k < 4 ; k++)
	    ...
	    FixedArrayBoundSequenceHolder out = 
		new FixedArrayBoundSequenceHolder();
...

	{
	    ...
	    VariableArrayBoundSequenceHolder inOut =
		new VariableArrayBoundSequenceHolder(new String[4][2][3]);
	    for(l = 0 ; l < 4 ; l++)
		for(i = 0 ; i < 2 ; i++)
		    for(j = 0 ; j < 3 ; j++)
			inOut.value[l][i][j] = "***";

	    VariableArrayBoundSequenceHolder out =
		new VariableArrayBoundSequenceHolder();
...

	{
	    ...
	    request.invoke();
            ...
            for(i = 0 ; i < requests.length ; i++)
            {
                ...
                requests[i].set_return_type(
                    m_orb.get_primitive_tc(TCKind.tk_ushort));
            }
