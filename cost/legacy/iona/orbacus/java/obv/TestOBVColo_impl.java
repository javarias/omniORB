...
public class TestOBVColo_impl extends TestOBVColoPOA
{
    ...
    public void
    test_value_attribute(TestValue a)
    {
        if(a != null)
        {
            TEST(a.count == count_);
    ...
    public TestValue
    test_value_op(TestValue v1, TestValueHolder v2, TestValueHolder v3)
    {
        if(v1 != null)
        {
    ...
    public void
    test_value_struct_attribute(SV a)
    {
        if(a.val != null)
        {
    ...
    public SV
    test_value_struct_op(SV s1, SVHolder s2, SVHolder s3)
    {
        if(s1.val != null)
        {
    ...
    public void
    test_value_union_attribute(UV a)
    {
    ...
    public UV
    test_value_union_op(UV u1, UVHolder u2, UVHolder u3)
    {
    ...
    public void
    test_value_seq_attribute(TestValue[] a)
    {
    ...
    public TestValue[]
    test_value_seq_op(TestValue[] s1, VSeqHolder s2, VSeqHolder s3)
    {
    ...
    public void
    test_abstract_attribute(TestAbstract a)
    {
        if(a != null)
        {
