...
final class TestServantLocatorServer extends test.common.TestBase
{
    ...
    main(String[] args)
    {
        ...
        try
        {
            ...
            policies[2] = root.create_request_processing_policy(
                ...
                USE_SERVANT_MANAGER);
            policies[3] = root.create_servant_retention_policy(
            ...
            org.omg.CORBA.Object reference1 =
                persistentPOA.create_reference_with_id(oid1, "IDL:test/poa/Test:1.0");
            org.omg.CORBA.Object reference2 =
                persistentPOA.create_reference_with_id(oid2, "IDL:test/poa/Test:1.0");
            org.omg.CORBA.Object reference3 =
                persistentPOA.create_reference_with_id(oid3, "IDL:test/poa/Test:1.0");
            org.omg.CORBA.Object reference4 =
                persistentPOA.create_reference_with_id(oid4, "IDL:test/poa/Test:1.0");
