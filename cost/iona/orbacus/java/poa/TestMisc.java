...
final class TestMisc extends test.common.TestBase
{
    static void
    TestCreateReference(ORB orb, POA root)
    {
	...
	{
	    obj = system.create_reference_with_id(id1, "IDL:Test:1.0");
	    TEST(false); // create_reference_with_id should have not succeeded
	}
	catch(BAD_PARAM ex)
	{
	    // Expected
    ...
    static void
    TestServantToId(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	...
	policies[0] = root.create_id_uniqueness_policy(
	...
	policies[0] = root.create_id_uniqueness_policy(
	    org.omg.PortableServer.IdUniquenessPolicyValue.UNIQUE_ID);
	policies[1] = root.create_servant_retention_policy(
	    org.omg.PortableServer.ServantRetentionPolicyValue.RETAIN);
	policies[2] = root.create_implicit_activation_policy(
	    org.omg.PortableServer.ImplicitActivationPolicyValue.
	    IMPLICIT_ACTIVATION);
	try
	{
    ...
    static void
    TestIdToServant(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	...
	policies[2] = root.create_id_assignment_policy(
	    org.omg.PortableServer.IdAssignmentPolicyValue.USER_ID);
	try
	{
	...
	policies[2] = root.create_request_processing_policy(
	    ...
	    USE_DEFAULT_SERVANT);
	policies[3] = root.create_lifespan_policy(
	    org.omg.PortableServer.LifespanPolicyValue.PERSISTENT);
	policies[4] = root.create_id_assignment_policy(
	    org.omg.PortableServer.IdAssignmentPolicyValue.USER_ID);
    ...
    static void
    TestServantToReference(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	POA unique, implicit, multiple;
    ...
    static void
    TestIdToReference(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	POA retain, defaultPOA;
	byte[] id1, id2, tmpid;
    ...
    static void
    TestReferenceToServant(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	POA retain, defaultPOA;
	byte[] id1, id2, tmpid;
    ...
    static void
    TestReferenceToId(ORB orb, POA root)
    {
	org.omg.CORBA.Object obj;
	POA poa;
	byte[] id1, id2, tmpid;
