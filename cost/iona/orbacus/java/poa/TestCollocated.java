...
final class TestCollocated extends test.common.TestBase
{
    ...
    static void
    TestDefaultServant(ORB orb, POA root, POAManager manager)
    {
	POA poa;
	Servant servant;
	Policy[] policies;
	...
	policies[4] = root.create_id_uniqueness_policy(
	    org.omg.PortableServer.IdUniquenessPolicyValue.MULTIPLE_ID);
	policies[5] = root.create_request_processing_policy(
	...
	Test_impl staticServant =
	    new Test_impl(orb, "defaultStaticServant", false);
	try
	{
    ...
    static void
    TestServantLocator(ORB orb, POA root, POAManager manager)
    {
	POA poa;
	Servant servant;
	Policy[] policies;
    ...
    static void
    TestServantActivator(ORB orb, POA root, POAManager manager)
    {
	POA poa;
	Servant servant;
	Policy[] policies;
