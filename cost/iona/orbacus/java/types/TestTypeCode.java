...
public class TestTypeCode extends test.common.TestBase
{
    ...
    TestTypeCode(ORB orb)
    {
	    ...
	    TEST(labelType.equal(com.ooc.OB.TypeCodeFactory.createPrimitiveTC(
		org.omg.CORBA_2_4.TCKind.from_int(org.omg.CORBA.TCKind._tk_short)
		)));
	...
	try
	{
        ...
        //
        {
            ...
            for(int i = 0 ; i < bogusIds.length ; i++)
            {
                ...
                try
                {
                    org.omg.CORBA.TypeCode tcShort =
                        orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_short);
                    org.omg.CORBA.UnionMember[] members =
                        new org.omg.CORBA.UnionMember[1];
                ...
                try
                {
                    ...
                    orb.create_value_tc(bogusIds[i], "foo",
                                        org.omg.CORBA.VM_NONE.value, null,
                                        members);
                    TEST(false);
                }
                catch(org.omg.CORBA.BAD_PARAM ex)
                ...
                try
                {
                    ((org.omg.CORBA_2_4.ORB)orb).
                        create_local_interface_tc(bogusIds[i], "foo");
                    TEST(false);
                }
                catch(org.omg.CORBA.BAD_PARAM ex)
                {
        ...
        //
        {
            ...
            for(int i = 0 ; i < bogusNames.length ; i++)
            {
                try
                {
                    ...
                    members[0].type =
                        orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_short);
                    orb.create_struct_tc("IDL:foo:1.0", bogusNames[i],
                                         members);
                    TEST(false);
                }
                catch(org.omg.CORBA.BAD_PARAM ex)
                ...
                {
                    ((org.omg.CORBA_2_4.ORB)orb).
                        create_local_interface_tc("IDL:foo:1.0",
                                                  bogusNames[i]);
                    TEST(false);
                }
                catch(org.omg.CORBA.BAD_PARAM ex)
        ...
        //
        {
            ...
            org.omg.CORBA.TypeCode exTC =
                orb.create_exception_tc("IDL:ex:1.0", "ex", members);
            ...
            for(int i = 0 ; i < types.length ; i++)
            {
                try
                {
                    org.omg.CORBA.StructMember[] seq =
                        new org.omg.CORBA.StructMember[1];
                ...
                try
                {
                    org.omg.CORBA.ValueMember[] seq =
                        new org.omg.CORBA.ValueMember[1];
