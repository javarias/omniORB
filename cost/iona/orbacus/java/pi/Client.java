...
final class Client extends test.common.TestBase
{
    private static void
    TestTranslation(ORB orb, ClientProxyManager manager, TestInterface ti)
    {
        //
    ...
    private static void
    TestCalls(ORB orb, ClientProxyManager manager, TestInterface ti)
    {
    ...
    private static void
    TestDIICalls(ORB orb, ClientProxyManager manager, TestInterface ti)
    {
	org.omg.PortableInterceptor.Current pic = null;
	try
	{
    ...
    static void
    ClientRegisterInterceptors(java.util.Properties props, boolean local)
    {
    ...
    static int
    ClientRun(ORB orb, boolean nonBlocking, String[] args)
	...
	//
	System.out.print(
            "Testing standard method calls with static stubs... ");
        System.out.flush();
