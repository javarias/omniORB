    ...
    implements ServerRequestInterceptor
{
    ...
    private void
    testArgs(ServerRequestInfo ri, boolean resultAvail)
    {
    ...
    private void
    testServiceContext(String op, ServerRequestInfo ri)
    {
	...
	if(op.equals("test_service_context"))
	{
	    ...
	    sc.context_id = REPLY_CONTEXT_ID.value;
	...
	//
	String mdi = ri.target_most_derived_interface();
	TEST(mdi.equals("IDL:test/pi/TestInterface:1.0"));
	...
	//
	TEST(ri.target_is_a("IDL:test/pi/TestInterface:1.0"));
	...
	//
        try
        {
            ri.target_is_a("IDL:test/pi/TestInterface:1.0");
            TEST(false);
        }
        catch(BAD_INV_ORDER ex)
        {
