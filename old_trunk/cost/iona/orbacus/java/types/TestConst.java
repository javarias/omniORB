    ...
    {
        {
            ...
            final BigDecimal constFixed =
                new BigDecimal("275.189").multiply(new BigDecimal("1.163")).
                    add(new BigDecimal("48.0093"));
...

        {
            ...
            TEST(constDouble ==
                 test.types.TestConstModule.ConstDouble.value);

            final boolean constBoolean = false;
            TEST(constBoolean ==
                 test.types.TestConstModule.ConstBoolean.value);

            final String constString = "This is ConstString in a module";
            TEST(constString.equals(
                 test.types.TestConstModule.ConstString.value));

            final String constWString = "This is ConstWString in a module";
            TEST(constWString.equals(
                 test.types.TestConstModule.ConstWString.value));
