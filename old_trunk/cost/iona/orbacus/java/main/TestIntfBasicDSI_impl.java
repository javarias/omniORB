    ...
    extends org.omg.PortableServer.DynamicImplementation
{
	...
	if (name.equals("opVoid"))
	{
		...
		ORBTest_Basic.ExVoidHelper.insert(
	...
	if (name.equals("opShort"))
	{
		...
		ORBTest_Basic.ExShortHelper.insert(
		    exAny,
	...
	if (name.equals("opUShort"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExUShortHelper.insert(
		    exAny,
	...
	if (name.equals("opLong"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExLongHelper.insert(
		    exAny,
	...
	if (name.equals("opULong"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExULongHelper.insert(
		    exAny,
	...
	if (name.equals("opFloat"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExFloatHelper.insert(
		    exAny, 
	...
	if (name.equals("opDouble"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExDoubleHelper.insert(
		    exAny,
	...
	if (name.equals("opBoolean"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExBooleanHelper.insert(
		    exAny,
	...
	if (name.equals("opChar"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExCharHelper.insert(
		    exAny,
	...
	if (name.equals("opOctet"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExOctetHelper.insert(
		    exAny, 
	...
	if (name.equals("opString"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExStringHelper.insert(
		    exAny,
	...
	if (name.equals("opAny"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExAnyHelper.insert(
		    exAny,
	...
	if (name.equals("_set_attrTestEnum"))
	{
		...
		ORBTest_Basic.TestEnumHelper.extract(any)
	    );
	...
	if (name.equals("opTestEnum"))
	{
		...
		ORBTest_Basic.TestEnumHelper.extract(any0)
	    );
	    ORBTest_Basic.TestEnumHolder arg1 = (
		new ORBTest_Basic.TestEnumHolder()
	    );
	    arg1._read(any1.create_input_stream());
	    ORBTest_Basic.TestEnumHolder arg2 = (
		new ORBTest_Basic.TestEnumHolder()
	    );
	...
	if (name.equals("_set_attrIntf"))
	{
	    ...
	    list.add_value("", any, org.omg.CORBA.ARG_IN.value);
	    request.arguments(list);
	    ORBTest_Basic.Intf arg =
		ORBTest_Basic.IntfHelper.extract(any);
	...
	if (name.equals("opIntf"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExIntfHelper.insert(
		    exAny,
	...
	if (name.equals("_set_attrFixedStruct"))
	{
	    ...
	    list.add_value("", any, org.omg.CORBA.ARG_IN.value);
	    request.arguments(list);
	    ORBTest_Basic.FixedStruct arg =
		ORBTest_Basic.FixedStructHelper.extract(any);
	...
	if (name.equals("opFixedStruct"))
	{
	    ...
	    list.add_value("", any2, org.omg.CORBA.ARG_OUT.value);
	    request.arguments(list);
	    ORBTest_Basic.FixedStruct arg0 = (
		ORBTest_Basic.FixedStructHelper.extract(any0)
	    );
	    ORBTest_Basic.FixedStructHolder arg1 = (
		new ORBTest_Basic.FixedStructHolder()
	    );
            arg1.value = ORBTest_Basic.FixedStructHelper.extract(any1);
	    ORBTest_Basic.FixedStructHolder arg2 = (
		new ORBTest_Basic.FixedStructHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExFixedStructHelper.insert(
		    exAny,
	...
	if (name.equals("_set_attrVariableStruct"))
	{
	    ...
	    list.add_value("", any, org.omg.CORBA.ARG_IN.value);
	    request.arguments(list);
	    ORBTest_Basic.VariableStruct arg = (
		ORBTest_Basic.VariableStructHelper.extract(any)
	    );
	...
	if (name.equals("opVariableStruct"))
	{
	    ...
	    list.add_value("", any2, org.omg.CORBA.ARG_OUT.value);
	    request.arguments(list);
	    ORBTest_Basic.VariableStruct arg0 = (
		ORBTest_Basic.VariableStructHelper.extract(any0)
	    );
	    ORBTest_Basic.VariableStructHolder arg1 = (
		new ORBTest_Basic.VariableStructHolder()
	    );
	    arg1.value = ORBTest_Basic.VariableStructHelper.extract(any1);
	    ORBTest_Basic.VariableStructHolder arg2 = (
		new ORBTest_Basic.VariableStructHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExVariableStructHelper.insert(
		    exAny,
	...
	if (name.equals("_set_attrFixedUnion"))
	{
	    ...
	    list.add_value("", any, org.omg.CORBA.ARG_IN.value);
	    request.arguments(list);
	    ORBTest_Basic.FixedUnion arg = (
		ORBTest_Basic.FixedUnionHelper.extract(any)
	    );
	...
	if (name.equals("opFixedUnion"))
	{
	    ...
	    list.add_value("", any2, org.omg.CORBA.ARG_OUT.value);
	    request.arguments(list);
	    ORBTest_Basic.FixedUnion arg0 = (
		ORBTest_Basic.FixedUnionHelper.extract(any0)
	    );
	    ORBTest_Basic.FixedUnionHolder arg1 = (
		new ORBTest_Basic.FixedUnionHolder()
	    );
            arg1.value = ORBTest_Basic.FixedUnionHelper.extract(any1);
	    ORBTest_Basic.FixedUnionHolder arg2 = (
		new ORBTest_Basic.FixedUnionHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExFixedUnionHelper.insert(
	...
	if (name.equals("_set_attrVariableUnion"))
	{
	    ...
	    list.add_value("", any, org.omg.CORBA.ARG_IN.value);
	    request.arguments(list);
	    ORBTest_Basic.VariableUnion arg =
		ORBTest_Basic.VariableUnionHelper.extract(any);
	...
	if (name.equals("opVariableUnion"))
	{
	    ...
	    list.add_value("", any2, org.omg.CORBA.ARG_OUT.value);
	    request.arguments(list);
	    ORBTest_Basic.VariableUnion arg0 = (
		ORBTest_Basic.VariableUnionHelper.extract(any0)
	    );
	    ORBTest_Basic.VariableUnionHolder arg1 = (
		new ORBTest_Basic.VariableUnionHolder()
	    );
	    arg1.value = ORBTest_Basic.VariableUnionHelper.extract(any1);
	    ORBTest_Basic.VariableUnionHolder arg2 = (
		new ORBTest_Basic.VariableUnionHolder()
	    );

	    ORBTest_Basic.VariableUnion ret = m_ti.opVariableUnion(arg0, arg1, arg2);

	    if (ex)
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExVariableUnionHelper.insert(
		    exAny, new ORBTest_Basic.ExVariableUnion(ret)
		);
		request.set_exception(exAny);
	    }
	    else
	...
	if (name.equals("opStringSequence"))
	{
	    ...
	    ORBTest_Basic.StringSequenceHolder arg1 = (
		new ORBTest_Basic.StringSequenceHolder()
	    );
            arg1.value = ORBTest_Basic.StringSequenceHelper.extract(any1);
	    ORBTest_Basic.StringSequenceHolder arg2 = (
		new ORBTest_Basic.StringSequenceHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExStringSequenceHelper.insert(
		    exAny, new ORBTest_Basic.ExStringSequence(ret)
		);
		request.set_exception(exAny);
	    }
	    else
	...
	if (name.equals("opFixedArray"))
	{
	    ...
	    ORBTest_Basic.FixedArrayHolder arg1 = (
		new ORBTest_Basic.FixedArrayHolder()
	    );
            arg1.value = ORBTest_Basic.FixedArrayHelper.extract(any1);
	    ORBTest_Basic.FixedArrayHolder arg2 = (
		new ORBTest_Basic.FixedArrayHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExFixedArrayHelper.insert(
	...
	if (name.equals("_set_attrVariableArray"))
	{
	    ...
	    request.arguments(list);
	    String[][] arg =
		ORBTest_Basic.VariableArrayHelper.extract(any);
	...
	if (name.equals("opVariableArray"))
	{
	    ...
	    ORBTest_Basic.VariableArrayHolder arg1 = (
		new ORBTest_Basic.VariableArrayHolder()
	    );
	    arg1.value = ORBTest_Basic.VariableArrayHelper.extract(any1);
	    ORBTest_Basic.VariableArrayHolder arg2 = (
		new ORBTest_Basic.VariableArrayHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExVariableArrayHelper.insert(
	...
	if (name.equals("_set_attrFixedArraySequence"))
	{
	    ...
	    request.arguments(list);
	    short[][][][] arg = (
		ORBTest_Basic.FixedArraySequenceHelper.extract(any)
	    );
	...
	if (name.equals("opFixedArraySequence"))
	{
	    ...
	    request.arguments(list);
	    short[][][][] arg0 = (
		ORBTest_Basic.FixedArraySequenceHelper.extract(any0)
	    );
	    ORBTest_Basic.FixedArraySequenceHolder arg1 = (
		new ORBTest_Basic.FixedArraySequenceHolder()
	    );
	    arg1.value = ORBTest_Basic.FixedArraySequenceHelper.extract(any1);
	    ORBTest_Basic.FixedArraySequenceHolder arg2 = (
		new ORBTest_Basic.FixedArraySequenceHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExFixedArraySequenceHelper.insert(
		    exAny, new ORBTest_Basic.ExFixedArraySequence(ret)
		);
		request.set_exception(exAny);
	    }
	    else
		...
		request.set_result(result);
		ORBTest_Basic.FixedArraySequenceHelper.insert(
		    any1, arg1.value
		);
		ORBTest_Basic.FixedArraySequenceHelper.insert(
		    any2, arg2.value
	...
	if (name.equals("_set_attrVariableArraySequence"))
	{
	    ...
	    request.arguments(list);
	    String[][][] arg = (
		ORBTest_Basic.VariableArraySequenceHelper.extract(any)
	    );
	...
	if (name.equals("opVariableArraySequence"))
	{
	    ...
	    request.arguments(list);
	    String[][][] arg0 = (
		ORBTest_Basic.VariableArraySequenceHelper.extract(any0)
	    );
	    ORBTest_Basic.VariableArraySequenceHolder arg1 =
		new ORBTest_Basic.VariableArraySequenceHolder();
	    arg1.value = (
		ORBTest_Basic.VariableArraySequenceHelper.extract(any1)
	    );
	    ORBTest_Basic.VariableArraySequenceHolder arg2 = (
		new ORBTest_Basic.VariableArraySequenceHolder()
	    );
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExVariableArraySequenceHelper.insert(
		    exAny, new ORBTest_Basic.ExVariableArraySequence(ret)
		);
		request.set_exception(exAny);
	    }
	    else
		...
		request.set_result(result);
		ORBTest_Basic.VariableArraySequenceHelper.insert(
		    any1, arg1.value
		);
		ORBTest_Basic.VariableArraySequenceHelper.insert(
		    any2, arg2.value
	...
	if (name.equals("_set_attrFixedArrayBoundSequence"))
	{
	    ...
	    request.arguments(list);
	    short[][][][] arg =
		ORBTest_Basic.FixedArrayBoundSequenceHelper.extract(any);
	...
	if (name.equals("opFixedArrayBoundSequence"))
	{
	    ...
	    request.arguments(list);
	    short[][][][] arg0 =
		ORBTest_Basic.FixedArrayBoundSequenceHelper.extract(any0);
	    ORBTest_Basic.FixedArrayBoundSequenceHolder arg1 =
		new ORBTest_Basic.FixedArrayBoundSequenceHolder();
	    arg1._read(any1.create_input_stream());
	    ORBTest_Basic.FixedArrayBoundSequenceHolder arg2 =
		new ORBTest_Basic.FixedArrayBoundSequenceHolder();
	    ...
	    {
		Any any = m_orb.create_any();
		ORBTest_Basic.ExFixedArrayBoundSequenceHelper.insert(
		    any, new ORBTest_Basic.ExFixedArrayBoundSequence(ret));
		request.set_exception(any);
	    }
	    else
	    {
		...
		request.set_result(any);
		ORBTest_Basic.FixedArrayBoundSequenceHelper.insert(
		    any1, arg1.value
		);
		ORBTest_Basic.FixedArrayBoundSequenceHelper.insert(
		    any2, arg2.value
	...
	if (name.equals("_set_attrVariableArrayBoundSequence"))
	{
	    ...
	    request.arguments(list);
	    String[][][] arg =
		ORBTest_Basic.VariableArrayBoundSequenceHelper.extract(any);
	...
	if (name.equals("opVariableArrayBoundSequence"))
	{
	    ...
	    request.arguments(list);
	    String[][][] arg0 =
		ORBTest_Basic.VariableArrayBoundSequenceHelper.extract(any0);
	    ORBTest_Basic.VariableArrayBoundSequenceHolder arg1 =
		new ORBTest_Basic.VariableArrayBoundSequenceHolder();
	    arg1._read(any1.create_input_stream());
	    ORBTest_Basic.VariableArrayBoundSequenceHolder arg2 =
		new ORBTest_Basic.VariableArrayBoundSequenceHolder();
	    ...
	    {
		Any any = m_orb.create_any();
		ORBTest_Basic.ExVariableArrayBoundSequenceHelper.insert(
		    any, new ORBTest_Basic.ExVariableArrayBoundSequence(ret));
		request.set_exception(any);
	    }
	    else
	    {
		...
		ORBTest_Basic.VariableArrayBoundSequenceHelper.insert(any, ret);
		request.set_result(any);
		ORBTest_Basic.VariableArrayBoundSequenceHelper.insert(
		    any1, arg1.value
		);
		ORBTest_Basic.VariableArrayBoundSequenceHelper.insert(
		    any2, arg2.value
	...
	if (name.equals("opExRecursiveStruct"))
	{
	    ...
	    {
		Any exAny = m_orb.create_any();
		ORBTest_Basic.ExRecursiveStructHelper.insert(
		    exAny,
		    new ORBTest_Basic.ExRecursiveStruct(
			ex_recursive_struct.us,
			ex_recursive_struct.rs
		    )
		);
		request.set_exception(exAny);
	    }
