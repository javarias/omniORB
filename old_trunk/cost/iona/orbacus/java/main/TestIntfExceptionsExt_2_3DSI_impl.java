    ...
    extends org.omg.PortableServer.DynamicImplementation
{
	...
	if(name.equals("op_CODESET_INCOMPATIBLE_"))
	{
	    ...
	    request.arguments(list);
            ...
            CODESET_INCOMPATIBLEHelper.insert(
                any,
		new CODESET_INCOMPATIBLE(31, CompletionStatus.COMPLETED_NO)
	    );
	...
	if(name.equals("op_REBIND_"))
	{
	    ...
	    request.arguments(list);
            ...
            Any any = m_orb.create_any();
            REBINDHelper.insert(
                any, new REBIND(32, CompletionStatus.COMPLETED_NO));
            request.set_exception(any);
	...
	if(name.equals("op_TIMEOUT_"))
	{
	    ...
	    request.arguments(list);
            ...
            Any any = m_orb.create_any();
            TIMEOUTHelper.insert(
                any, new TIMEOUT(33, CompletionStatus.COMPLETED_NO));
            request.set_exception(any);
	...
	if(name.equals("op_TRANSACTION_UNAVAILABLE_"))
	{
	    ...
	    request.arguments(list);
            ...
            Any any = m_orb.create_any();
            TRANSACTION_UNAVAILABLEHelper.insert(
                any, new TRANSACTION_UNAVAILABLE(
		    34,  CompletionStatus.COMPLETED_NO));
            request.set_exception(any);
	...
	if(name.equals("op_TRANSACTION_MODE_"))
	{
	    ...
	    request.arguments(list);
            ...
            Any any = m_orb.create_any();
            TRANSACTION_MODEHelper.insert(
                any, new TRANSACTION_MODE(35, CompletionStatus.COMPLETED_NO));
            request.set_exception(any);
	...
	if(name.equals("op_BAD_QOS_"))
	{
	    ...
	    request.arguments(list);
            ...
            Any any = m_orb.create_any();
            BAD_QOSHelper.insert(
                any, new BAD_QOS(36, CompletionStatus.COMPLETED_NO));
            request.set_exception(any);
