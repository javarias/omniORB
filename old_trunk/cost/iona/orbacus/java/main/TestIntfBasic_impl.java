...
final class TestIntfBasic_impl extends ORBTest_Basic.IntfPOA
{
    ...
    public synchronized ORBTest_Basic.TestEnum
    attrTestEnum()
    {
	return m_aTestEnum;
    }
    ...
    public synchronized void
    attrTestEnum(ORBTest_Basic.TestEnum value)
    {
	m_aTestEnum = value;
    }
	...
	ORBTest_Basic.TestEnumHolder a1,
    ...
    public synchronized ORBTest_Basic.Intf
    attrIntf()
    {
    ...
    public synchronized ORBTest_Basic.Intf
    opIntf(
	ORBTest_Basic.Intf a0,
	ORBTest_Basic.IntfHolder a1,
	ORBTest_Basic.IntfHolder a2
    )
    {
	m_aTestIntfBasic = a0;
    ...
    public synchronized FixedStruct
    attrFixedStruct()
    {
    ...
    public synchronized VariableStruct
    attrVariableStruct()
    {
    ...
    public synchronized FixedUnion
    attrFixedUnion()
    {
    ...
    public synchronized VariableUnion
    attrVariableUnion()
    {
	...
	m_aFixedArrayBoundSequence = (
	    new short[a0.length + a1.value.length][][][]
	);
	int idx = 0;
	for (int i = 0 ; i < a0.length ; i++)
	{
	...
	m_aVariableArrayBoundSequence = (
	    new String[a0.length + a1.value.length][][]
	);
	int idx = 0;
	for (int i = 0 ; i < a0.length ; i++)
	{
	...
	m_aRecursiveStruct.s = new String("test");
	...
	m_aRecursiveStruct.rs[0].s = (
	    new String("ORBTest_Basic_RecursiveStruct")
	);
