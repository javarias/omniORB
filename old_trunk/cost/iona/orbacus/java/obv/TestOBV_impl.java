...
public class TestOBV_impl extends TestOBVPOA
{
    ...
    private TestInterfacePOATie valueInterfaceTie_;
    ...
    public void
    get_two_values(TestValueHolder v1, TestValueHolder v2)
    {
        v1.value = value_;
        v2.value = value_;
    }
    ...
    public void
    set_two_values(TestValue v1, TestValue v2)
    {
        TEST(v1 != null);
        TEST(v2 != null);
        TEST(v1 == v2);
    ...
    public void
    get_two_valuesubs_as_values(TestValueHolder v1, TestValueHolder v2)
    {
        org.omg.CORBA_2_3.ORB orb_2_3 = (org.omg.CORBA_2_3.ORB)orb_;
        TestValueSubValueFactory subFactory = (TestValueSubValueFactory)
            orb_2_3.lookup_value_factory(TestValueSubHelper.id());
    ...
    public void
    set_two_valuesubs_as_values(TestValue v1, TestValue v2)
    {
        TEST(v1 != null);
        TEST(v2 != null);
        v1.ping1();
    ...
    public void
    get_node(TestNodeHolder n, org.omg.CORBA.IntHolder count)
    {
        n.value = node_;
    ...
    public void
    set_string_box(String b, String value)
    {
        TEST(b != null);
        TEST(b.equals(value));
    }
    ...
    public void
    set_ulong_box(TestULongBox b, int value)
    {
        TEST(b != null);
        TEST(b.value == value);
    }
    ...
    public void
    set_fix_struct_box(TestFixStruct b, TestFixStruct value)
    {
        TEST(b != null);
        TEST(b.x == value.x);
        TEST(b.y == value.y);
    ...
    public void
    set_var_struct_box(TestVarStruct b, TestVarStruct value)
    {
        TEST(b != null);
    ...
    public void
    set_fix_union_box(TestFixUnion b, TestFixUnion value)
    {
        TEST(b != null);
    ...
    public void
    set_var_union_box(TestVarUnion b, TestVarUnion value)
    {
        TEST(b != null);
    ...
    public void
    set_anon_seq_box(short[] b, int length)
    {
        TEST(b != null);
    ...
    public void
    set_string_seq_box(String[] b, String[] value)
    {
        TEST(b != null);
    ...
    public void
    set_ai_interface_any(org.omg.CORBA.Any any)
    {
        //
    ...
    public void
    remarshal_any(org.omg.CORBA.Any any)
    {
        // nothing to do
    }

    public void
    get_two_value_anys(org.omg.CORBA.AnyHolder a1, org.omg.CORBA.AnyHolder a2)
    {
        TestValue v = get_value();
    ...
    public void
    set_two_value_anys(org.omg.CORBA.Any a1, org.omg.CORBA.Any a2)
    {
