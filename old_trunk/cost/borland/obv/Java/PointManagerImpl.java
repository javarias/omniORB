...
public class PointManagerImpl extends PointManagerPOA {
  private Point[] _points = new Point[256];
  private int _num_points;
  private java.lang.String _manager_name;
  private boolean _verbose;
 
  public PointManagerImpl(java.lang.String manager_name, boolean verbose) {
    _manager_name = manager_name;
    _num_points = 0;
    _verbose = verbose;
  }

  public Point create_point (int x, int y, java.lang.String lab, boolean connectable) throws DuplicatePoint, InvalidPoint {
    if (lab == null) {
      throw new InvalidPoint();
    }

    if (_verbose) {
      java.lang.String connect_string = (connectable ? "connected" : "disconnected");
      System.out.println("PointManager::creating [" + connect_string + "] point for [" + lab + ", " + x + ", " + y + "]");
    }
  ...
  public Point get_point (java.lang.String lab) throws UnknownPoint, InvalidPoint {
    if (lab == null) {
      throw new InvalidPoint();
    }
  ...
  public void destroy_point (java.lang.String lab) throws UnknownPoint, InvalidPoint {
    if (lab == null) {
      throw new InvalidPoint();
    }
  ...
  public Point[] list_points (int scaling_factor) {
    if (_verbose) {
      System.out.println("PointManager::list_points with scaling [" + scaling_factor + "]");
    }
  ...
  public void connect_point (java.lang.String lab, java.lang.String[] connectTo) throws UnknownPoint, InvalidPoint {
    if (lab == null) {
      throw new InvalidPoint();
    }
  ...
  private int _find(java.lang.String label) {
    int i;
  ...
  private boolean _remove_point(java.lang.String label) {
  ...
  private Point _find_point(java.lang.String label) {
    int index = _find(label);
    if (index < _num_points) {
